...
//    public void onCreate(Bundle icycle) {
    ...
    protected void onResume() {
        ...
        if (mService == null) {
            ...
            try {
                if (null == startService(new Intent(
                            SoundRecorder.this, SoundRecorderService.class))) {
                    LogUtils.e(TAG, "<onResume> fail to start service");
                    finish();
                    return;
                }
            } catch (Exception e) {
                LogUtils.e(TAG, "onResume startService exception " + e);
                finish();
                return;
            }
...
//            return super.onKeyDown(keyCode, event);
    ...
    void onClickRecordButton() {
        ...
        LogUtils.d(TAG, "<onClickRecordButton1> " + recordAudioPermission);
